...
return [
    ...
    'types' => [
        '0' => [
            'showitem' => 'job_uid, item_type, source_table, base_uid, source_uid, target_uid, source_page_uid, status, error_code, error_message',
        ],
    ],
    'columns' => [
        ...
        'base_uid' => ['config' => ['type' => 'number', 'readOnly' => true]],
        ...
        'error_code' => ['config' => ['type' => 'input', 'readOnly' => true]],
